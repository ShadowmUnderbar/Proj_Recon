...
s.frame_set(1);(P/'Local_Clearance_Final.json').write_text(json.dumps(logs,indent=2));bpy.ops.wm.save_as_mainfile(filepath=str(P/'ElseIf_Game_MobileVR_Test.blend'));print(json.dumps(logs))
