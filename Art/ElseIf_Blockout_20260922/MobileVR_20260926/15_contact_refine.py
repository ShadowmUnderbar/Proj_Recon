...
frames=[1,11,41,51,61,71,91,101];bad={n:set() for n in ['Jacket','ElseIf_Anatomy_Restoration']};log={}
for frame in frames:
...
(P/'Adaptive_Refinement_2.json').write_text(json.dumps(log,indent=2));bpy.ops.wm.save_as_mainfile(filepath=str(P/'ElseIf_Game_MobileVR_Test.blend'));print(log)
