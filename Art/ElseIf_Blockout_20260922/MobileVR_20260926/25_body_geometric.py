...
r={'before_triangles':before,'after_triangles':after,'protected_points':len(protected),'max_protected_vertex_distance_mm':mx*1000};(P/'Body_Density_Reduction_Geometric.json').write_text(json.dumps(r,indent=2));bpy.ops.wm.save_as_mainfile(filepath=str(P/'ElseIf_Game_MobileVR_Test.blend'));print(r)
